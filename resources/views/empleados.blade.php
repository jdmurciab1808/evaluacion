  ...
  @csrf
    ...
    <fieldset class="row mx-0">
      <div class="col-md-4 col-sm-12">
        ...
        <input autocomplete="off" type="text" name="nombreCompleto" id="nombreCompleto" required placeholder="Nombre Completo" />
        ...
        <div class="d-flex align-items-center">
          <select class="browser-default custom-select mg-lg-4">
            ...
            <option value="Dirección de Investigación y Planeación">Dirección de Investigación y Planeación</option>
            ...
            <option value="Dirección de Desarrollo de las Organizaciones Solidarias">Dirección de Desarrollo de las Organizaciones Solidarias</option>
            <option value="Grupo de Sinergias Interinstitucionales">Grupo de Sinergias Interinstitucionales</option>
      ...
      <div class="form-row">
        <div class="col-md-4">
          <div class="mb-3">
            ...
            <input type="text" class="form-control compromiso" id="evaluado" placeholder="Nombres y Apellidos">
          </div>
        </div>
          <div class="col-md-4">
            <div class="mb-3">
              <label class="block font-medium text-sm text-gray-700" for="archivo" style="float: left">Cargue su Firma (En formato PDF)</label>
    ...
    <fieldset>
      ...
      <div class="form-row">
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="mb-3">
              <label class="block font-medium text-sm text-gray-700" for="archivo" style="float: left" >Número de Días</label>
    ...
    <fieldset>
      ...
      <div class="md-form mt-3">
        ...
        <textarea id="form10" class="md-textarea form-control" rows="3" placeholder="Escribe en este área de texto las observaciones que tengas respecto al evaluado"></textarea>
      </div>
